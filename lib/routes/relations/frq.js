...
async function init(appContext) {
    ...
    appContext.app.post(`/v1/user/relations/add`, async (req, res)=>{
        try {
            // Validate
            validateSchema({
                tag: { type: 'string' }
    ...
    appContext.app.post(`/v1/user/relations/accept`, async (req, res)=>{
        try {
            // Validate
            validateSchema({
    ...
    appContext.app.post(`/v1/user/relations/deny`, async (req, res)=>{
        try {
            // Validate
            validateSchema({
                target: { type: 'string' } // The ID of the user to accept the request from
     ...
     appContext.app.post(`/v1/user/relations/retract`, async (req, res)=>{
        try {
            // Validate
            validateSchema({
                target: { type: 'string' } // The ID of the user to accept the request from
    ...
    appContext.app.post(`/v1/user/relations/remove`, async (req, res)=>{
        try {
            // Validate
            validateSchema({
                target: { type: 'string' } // The ID of the user to accept the request from
